...
This exploratory data analysis (EDA) is comprised of two parts: (1) the univariate analysis which examines the frequencies and proportions of categorical variables and the centrality, variability, spread and shape of the distributions of quantitative variables, and (2) the bivariate analysis which explores the relationships between the independent variables and audience scores.

## Univariate Analysis
### Qualitative Variables
#### Summary Variables
 `r kfigr::figr(label = "films_summary", prefix = TRUE, link = TRUE, type="Figure")`, shows the counts and percentages for three *summary* variables: the drama, the feature film, and the MPAA R rating indicator variables. Drama and R rated films comprised a slight plurality of films in the sample and nearly all the films were indeed, feature films.
