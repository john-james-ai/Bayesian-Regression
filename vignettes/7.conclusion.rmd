...
In short, the selection of default prior was not decisive for inference nor prediction on this data set. Future studies should be conducted on a range of data sets with different parameter sets to ascertain the degree to which the impact of default prior specification is data dependent.
