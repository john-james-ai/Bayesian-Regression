...
This experiment explores the following nine default priors supported in literature (`r kfigr::figr(label = "priors", prefix = TRUE, link = TRUE, type="Table")`). The **Bayesian Information Criterior (BIC) prior** is a reference prior based upon an approximation of the log marginal likelihood of parameter value $\theta$ using the Bayesian information criterion.  
