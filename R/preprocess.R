...
preprocess <- function(data, trim = NULL) {
  ...
  data$imdb_num_votes_sqrt <- sqrt(data$imdb_num_votes)
  ...
  data <- data %>% select(title, feature_film, drama, runtime, mpaa_rating_R,
                          ...
                          imdb_rating, imdb_num_votes, imdb_num_votes_log,
                          imdb_num_votes_sqrt, critics_score,
                          best_pic_nom, best_pic_win, 
                          best_actor_win, best_actress_win, best_dir_win, 
                          top200_box,  imdb_num_votes_log, audience_score)
